 ...
 */
export function loadContext(aiPath) {
 ...
 */
export function loadProfile(aiPath, profileName) {
 ...
 */
export function loadAgent(aiPath, agentName) {
 ...
 */
export function loadRule(aiPath, rulePath) {
    ...
    try {
        ...
        throw new Error(`Failed to load rule ${rulePath}: ${error.message}`);
    }
}
/**
 ...
 */
export function fileExists(aiPath, filePath) {
