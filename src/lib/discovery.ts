 ...
 */
export function findAiFolder(startDir: string = process.cwd()): string | null {
 ...
 */
export function hasAiFolder(dir: string): boolean {
 ...
 */
export function getProjectRoot(aiPath: string): string {
